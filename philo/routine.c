...
/*   Updated: 2026/02/09 15:42:48 by adores           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	is_eating(t_philo *philo)
{
	if (philo->philo_id % 2 == 0)
	{
		...
		monitor_eat(philo);
		my_usleep(philo->data, philo->data->to_eat);
...
void	is_thinking(t_philo *philo)
{
	...
	if (philo->data->n_philos % 2 == 0)
		return ;
	think = philo->data->to_eat * 2 - philo->data->to_sleep;
	if (think < 0)
		think = philo->data->to_eat * 0.1;
...
void	is_sleeping(t_philo	*philo)
{
	...
	my_usleep(philo->data, philo->data->to_sleep);
}
